  ...
  try {
    ...
    if (shouldUpdate) {
      ...
      console.log(`Dados carregados com sucesso! ${totalUpdated} jogos adicionados.`);
        // Clear cached Apostas mapping so batched queries rebuild with new data
    try { clearApostasCache(); console.log('🔁 Apostas cache invalidada após refresh automático'); } catch (e) { /* ignore */ }
